...
namespace Main\Proxies\__CG__\Main\Model\Page;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Choice extends \Main\Model\Page\Choice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'target', 'description', 'status', 'position', 'id', '_errors', '_readonly'];
        }
    ...
    public function setParent($parent, $keepConsistency = true)
    {
        ...
        return parent::setParent($parent, $keepConsistency);
    }
