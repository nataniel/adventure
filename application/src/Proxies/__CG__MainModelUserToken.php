 ...
 */
class Token extends \Main\Model\User\Token implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'type', 'hash', 'created_at', 'expires_at', 'value', 'id', '_errors', '_readonly'];
        }
    ...
    public function setExpired()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExpired', []);

        return parent::setExpired();
    }
    ...
    public function generateHash()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'generateHash', []);
