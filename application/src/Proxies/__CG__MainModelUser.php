...
class User extends \Main\Model\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function delFromProfiles(\Main\Model\User\Profile $profile, $keepConsistency = true)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'delFromProfiles', [$profile, $keepConsistency]);

        return parent::delFromProfiles($profile, $keepConsistency);
    }
