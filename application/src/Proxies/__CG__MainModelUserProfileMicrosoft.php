...
namespace Main\Proxies\__CG__\Main\Model\User\Profile;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Microsoft extends \Main\Model\User\Profile\Microsoft implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'profile_id', 'created_at', 'id', '_errors', '_readonly'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Microsoft $proxy) {
     ...
     * {@inheritDoc}
     */
    public function belongsTo(\Main\Model\User $user)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'belongsTo', [$user]);

        return parent::belongsTo($user);
    }
