...
namespace Main\Proxies\__CG__\Main\Model\Game;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Operator extends \Main\Model\Game\Operator implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'game', 'user', 'type', 'id', '_errors', '_readonly'];
        }
